...
public class DtoAnnonceur implements Serializable {
	...
	public DtoAnnonceur(int id,String nom,String telephone,String email,String lieuNom,String lieuAdresse,String lieuCp,String lieuVille,String siteWeb){
		super();
		this.setId(id);
		this.setNom(nom);
