...
public final class Roles {
	...
	public static final String MODERATEUR		= "Modérateur";
	...
	// MÃ©thode anonyme statique
	static {

		roles.add( new Role( ADMINISTRATEUR,	"Administrateur"	) );
		roles.add( new Role( MODERATEUR,		"Modérateur"		) );
	...
	// Constructeur privÃ© qui empÃªche l'instanciation de la classe
	private Roles() {
	}
